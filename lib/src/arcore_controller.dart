...
//  UnsupportedHandler onUnsupported;
  ...
  Future<dynamic> _handleMethodCalls(MethodCall call) async {
    ...
    switch (call.method) {
      ...
      case 'onPlaneDetected':
        if (onPlaneDetected && enableUpdateListener = null) {
  ...
  Future<void> removeNode({String nodeName}) {
  ...
  Future<void> loadSingleAugmentedImage({Uint8List bytes}) {
    assert(bytes = null);
  ...
  Future<void> loadAugmentedImagesDatabase({Uint8List bytes}) {
    assert(bytes = null);
